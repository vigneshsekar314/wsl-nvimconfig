...
_G.packer_plugins = {
  LuaSnip = {
    loaded = true,
    path = "/home/vignesh/.local/share/nvim/site/pack/packer/start/LuaSnip",
  ...
  harpoon = {
    loaded = true,
    path = "/home/vignesh/.local/share/nvim/site/pack/packer/start/harpoon",
    url = "https://github.com/ThePrimeagen/harpoon"
  },
  ["lsp-zero.nvim"] = {
    loaded = true,
    path = "/home/vignesh/.local/share/nvim/site/pack/packer/start/lsp-zero.nvim",
  ...
  ["nvim-treesitter"] = {
    loaded = true,
    path = "/home/vignesh/.local/share/nvim/site/pack/packer/start/nvim-treesitter",
  ...
  playground = {
    loaded = true,
    path = "/home/vignesh/.local/share/nvim/site/pack/packer/start/playground",
  ...
  ["rose-pine"] = {
    loaded = true,
    path = "/home/vignesh/.local/share/nvim/site/pack/packer/start/rose-pine",
  ...
  undotree = {
    loaded = true,
    path = "/home/vignesh/.local/share/nvim/site/pack/packer/start/undotree",
